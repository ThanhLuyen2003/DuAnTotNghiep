  ...
  return (
    <ScrollView style={{ width: "100%" }}>
      ...
      <View style={{ width: "100%", padding: 10 }}>
        ...
        <Text>II.Miễn trừ trách nhiệm trong trường hợp phát sinh lỗi kỹ thuật của website shop.polybarber.com{"\n"}- shop.polybarber.com cam kết nỗ lực đảm bảo website hoạt động an toàn, ổn định và liên tục. Tuy nhiên, trong trường hợp website phát sinh lỗi kỹ thuật như: lỗi phần mềm, lỗi hệ thống đường truyền Internet hoặc các lỗi khách quan khác dẫn đến Khách hàng không thể đặt hàng trên website, Khách hàng vui lòng thông báo ngay và kịp thời cho polybarber, Chúng tôi sẽ khắc phục lỗi trong thời gian sớm nhất.{"\n"}- shop.polybarber.com không chịu trách nhiệm giải quyết các khiếu nại của Khách hàng phát sinh trong trường hợp website shop.polybarber.com phát sinh lỗi kỹ thuật, lỗi phần mềm, hệ thống đường truyền Internet hoặc các lỗi khác không do shop.polybarber.com gây ra.</Text>
